...
if __name__ == '__main__':
    #model = build_model()
    model_path_save_json = 'models/drusen_inceptionV3.json'
    model_path_save = 'models/drusen_inceptionV3.h5'
    ...
    gradcam, gb, guided_gradcam = compute_saliency(model, guided_model, layer_name='conv2d_94',
